  ...
  return(
    <section className="leaderboard">
      <div className="container mx-auto px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 leaderboard-name pt-48">
          <div className="order-1 md:order-2 card rank-1 md:mx-16 md:relative grid grid-cols-2 md:grid-cols-1 my-4">
            <div>
              <Image
                ...
                width={40}
                height={40}
                className="rank !w-[110px] !h-[110px] my-12 md:!w-[166px] md:!h-[166px] md:-translate-y-36 md:overflow-visible"
                unoptimized
              />
            </div>
            <div className="pt-12">
              <span className="leaderboard-name">Moch****</span>
          ...
          <div className="order-2 md:order-1 card rank-2 md:mx-16 md:relative grid grid-cols-2 md:grid-cols-1 my-4 md:translate-y-16">
            <div>
              <Image
                ...
                width={40}
                height={40}
                className="rank !w-[110px] !h-[110px] my-12 md:!w-[166px] md:!h-[166px] md:-translate-y-28 md:overflow-visible"
                unoptimized
              />
            </div>
            <div className="pt-12">
              <span className="leaderboard-name">Irna****</span>
          ...
          <div className="order-3 md:order-3 card rank-3 md:mx-16 md:relative grid grid-cols-2 md:grid-cols-1 my-4 md:translate-y-24">
            ...
            <div className="pt-12">
              <span className="leaderboard-name">linatul****</span>
